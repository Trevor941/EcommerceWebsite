                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <span> ID:{{$product->id}} | <a href="{{route('products.edit', $product->id)}}">Edit</a> | <a class="text-danger" href="">Trash</a> | <a class="" href="">View</a> | <a href="">Duplicate</a>
                            </span>
                            </td>
                            <td>{{$product->SKU}}</td>
                            <td>{{$product->stock}}</td>
